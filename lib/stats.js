...
class StatsTracker {
  ...
  recordMatch(meta = {}) {
    ...
    const matchEntry = {
      ...
      method: meta.method || 'exemplar_distance',
      score: meta.score !== undefined ? meta.score : null,
      classifierProbability: meta.classifierProbability !== undefined ? meta.classifierProbability : null,
